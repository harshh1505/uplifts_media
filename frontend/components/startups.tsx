  ...
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-3xl sm:text-4xl sm:text-5xl font-bold text-[#0A1A3A] mb-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div
            className="relative h-64 sm:h-96 bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-6 sm:p-8 flex items-end justify-start overflow-hidden border border-gray-200"
