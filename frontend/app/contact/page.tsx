...
export default function ContactPage() {
  return (
    <div className="bg-white px-4 sm:px-6 pt-28 sm:pt-12 pb-24 overflow-hidden relative">
      {/* Decorative elements */}
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold text-[#0A1A3A] mb-8 tracking-tight">
        ...
        {/* Form */}
        <motion.section
          className="max-w-3xl mx-auto bg-white border border-gray-100 p-6 sm:p-8 md:p-12 rounded-[2rem] sm:rounded-[2.5rem] shadow-xl shadow-blue-500/5"
